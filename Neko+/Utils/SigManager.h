...
public:
    ...
    DEFINE_SIG(ComplexInventoryTransaction_vtable, "48 8D 05 ? ? ? ? 48 8B F9 48 89 01 8B DA 48 83 C1 ? E8 ? ? ? ? F6 C3 ? 74 ? BA ? ? ? ? 48 8B CF E8 ? ? ? ? 48 8B 5C 24 ? 48 8B C7 48 83 C4 ? 5F C3 CC CC CC CC CC CC CC CC CC CC CC CC CC CC 48 89 5C 24 ? 48 89 74 24 ? 57 41 56", SigType::RefSig, 3); 
    ...
    DEFINE_SIG(ItemReleaseInventoryTransaction_vtable, "48 8d 05 ? ? ? ? 48 89 43 ? c6 83 ? ? ? ? ? 89 ab ? ? ? ? c6 83 ? ? ? ? ? 89 ab ? ? ? ? 0f 57 c0 0f 11 83 ? ? ? ? 48 89 ab ? ? ? ? 48 c7 83 ? ? ? ? ? ? ? ? c6 83 ? ? ? ? ? 48 89 ab ? ? ? ? 89 ab", SigType::RefSig, 3);
    ...
    DEFINE_SIG(MinecraftPackets_createPacket, "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 44 24 ? 48 8B D9 48 89 4C 24 ? 33 F6", SigType::Sig, 0);
    ...
    DEFINE_SIG(Actor_getStatusFlag, "E8 ? ? ? ? 84 C0 75 ? 48 8B CF E8 ? ? ? ? 48 8B C8", SigType::RefSig, 1);
    ...
    DEFINE_SIG(tickEntity_ItemUseSlowdownModifierComponent, "48 89 ? ? ? 48 89 ? ? ? 57 48 83 EC ? 49 8B ? 4D 85", SigType::Sig, 0);
    ...
    DEFINE_SIG(FastEat, "45 0F B6 F4 48 8D 4F", SigType::Sig, 0);
    ...
    DEFINE_SIG(ConnectionRequest_create_DefaultInputMode, "48 8D 4C 24 ? E8 ? ? ? ? 90 48 8D 15 ? ? ? ? 48 8D 4D ? E8 ? ? ? ? 48 8B C8 48 8D 54 24 ? E8 ? ? ? ? 90 48 8D 4C 24 ? E8 ? ? ? ? 8B 54 24 ? 48 8D 4C 24 ? E8 ? ? ? ? 90 48 8D 15 ? ? ? ? 48 8D 4D ? E8 ? ? ? ? 48 8B C8 48 8D 54 24 ? E8 ? ? ? ? 90 48 8D 4C 24 ? E8 ? ? ? ? 8B 95", SigType::Sig, 0);
    DEFINE_SIG(ConnectionRequest_create_CurrentInputMode, "8B 54 24 ? 48 8D 4C 24 ? E8 ? ? ? ? 90 48 8D 15 ? ? ? ? 48 8D 4D ? E8 ? ? ? ? 48 8B C8 48 8D 54 24 ? E8 ? ? ? ? 90 48 8D 4C 24 ? E8 ? ? ? ? 8B 95", SigType::Sig, 0);
    DEFINE_SIG(InputModeBypass, "8b d7 48 8b ce 48 8b 80 ? ? ? ? ff 15 ? ? ? ? 49 8b 07", SigType::Sig, 0);
    DEFINE_SIG(InputModeBypassFix, "49 8b 07 8b d7 49 8b cf 48 8b 80 ? ? ? ? ff 15 ? ? ? ? 49 8b 07", SigType::Sig, 0);
    ...
    DEFINE_SIG(CameraComponent_applyRotation, "66 0F ? ? 0F 5B ? 0F 2F ? 76 ? F3 0F ? ? F3 0F", SigType::Sig, 0); 
    ...
    DEFINE_SIG(GammaSig, "48 83 EC ? 80 B9 ? ? ? ? ? 48 8D 54 24 ? 48 8B 01 48 8B 40 ? 74 ? 41 B8 ? ? ? ? FF 15 ? ? ? ? 48 8B 10 48 85 D2 74 ? 48 8B 42 ? 48 8B 88 ? ? ? ? 48 85 C9 74 ? E8 ? ? ? ? 48 83 C4 ? C3 F3 0F 10 42 ? 48 83 C4 ? C3 41 B8 ? ? ? ? FF 15 ? ? ? ? 48 8B 10 48 85 D2 75 ? E8 ? ? ? ? CC E8 ? ? ? ? CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC CC 48 89 5C 24", SigType::Sig, 0);
    DEFINE_SIG(ZoomSig, "48 8B C4 48 89 58 ? 48 89 70 ? 57 48 81 EC ? ? ? ? 0F 29 70 ? 0F 29 78 ? 44 0F 29 40 ? 44 0F 29 48 ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 44 24 ? 41 0F B6 F0", SigType::Sig, 0);
    DEFINE_SIG(Fistpr, "48 83 EC 28 48 8B 01 48 8D 54 24 30 41 B8 03 00 00 00", SigType::Sig, 0);
